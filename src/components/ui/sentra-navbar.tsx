          ...
          <div className="flex items-center gap-2">
                      ...
                      {navigationLinks.map((link, index) => (
                        <NavigationMenuItem key={index} className="w-full">
                          <button
                            ...
                            className={cn(
                              'flex w-full items-center rounded-md px-3 py-2 text-sm font-normal lowercase transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground cursor-pointer no-underline',
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <span className="hidden font-bold text-xl sm:inline-block">sentra/ framework</span>
              </button>
              {/* Navigation menu */}
              {!isMobile && (
                    ...
                    {navigationLinks.map((link, index) => (
                      <NavigationMenuItem key={index}>
                        <NavigationMenuLink
                          ...
                          onClick={(e) => e.preventDefault()}
                          className={cn(
                            'group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-normal lowercase transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 cursor-pointer relative',
...
SentraNavbar.displayName = 'SentraNavbar';
export default SentraNavbar;
