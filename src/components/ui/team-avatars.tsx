...
export default function TeamAvatars() {
  ...
  return (
    <div
      className="flex flex-col lg:flex-row items-start lg:items-center ml-[300px] mt-[20px]"
    ...
    >
      ...
      <div className="text-left max-w-xl">
        ...
        <p className="text-[17px] leading-[1.8] font-medium text-gray-600 mt-4">
          Dibangun oleh tim AI berstandar industri.
        </p>
